  ...
  const htmlBody = `
    <div style="font-family:system-ui,Arial;max-width:600px;margin:0 auto;">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0;">
        <tr><td style="padding:8px;border-bottom:1px solid #e2e8f0;color:#64748b;">N° de orden (app)</td>
            <td style="padding:8px;border-bottom:1px solid #e2e8f0;font-weight:600;">${orderId.slice(0, 8)}</td></tr>
        <tr><td style="padding:8px;border-bottom:1px solid #e2e8f0;color:#64748b;">ID completo</td>
            <td style="padding:8px;border-bottom:1px solid #e2e8f0;font-family:monospace;font-size:0.85em;">${orderId}</td></tr>
